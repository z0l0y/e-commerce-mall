 ...
 */
@RestController
@RequestMapping("ecommercemallproduct/attrgroup")
public class AttrGroupController {
    ...
    // @RequiresPermissions("ecommercemallproduct:attrgroup:list")
...
//        PageUtils page = attrGroupService.queryPage(params);
    ...
    // @RequiresPermissions("ecommercemallproduct:attrgroup:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("ecommercemallproduct:attrgroup:save")
    ...
    // @RequiresPermissions("ecommercemallproduct:attrgroup:update")
    ...
    // @RequiresPermissions("ecommercemallproduct:attrgroup:delete")
